    ...
    <v-container class="module-instruct">
      <div class="module-instruct__container">
        ...
        <div class="module-instruct__instructions">
          ...
          <div
            v-for="(i, index) in pitchesInstructions"
            :key="index"
          ...
          >
            ...
            <validation-provider v-slot="{ errors }" slim rules="required">
              <v-textarea
                v-model="pitchesInstructions[index]"
                row-height="3"
                rows="1"
                outlined
...
export default {
  name: 'ModuleInstruct',
  setup() {
    const pitchesInstructions = ref(['']);
    const goal = ref(['']);
    function populate() {
      pitchesInstructions.value.push('');
    }
    return { pitchesInstructions, populate, goal };
  }
};
</script>
